...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || ClientViewFragment.class.getName().equals(fragmentName)
                || DiaryFragment.class.getName().equals(fragmentName)
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class ClientViewFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            ...
            addPreferencesFromResource(R.xml.pref_client_view);
            ...
            // guidelines.
            //bindPreferenceSummaryToValue(findPreference("app.theme"));
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class DiaryFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            PreferenceManager prefMgr = getPreferenceManager();
            prefMgr.setSharedPreferencesName(Utils.mPrefsFile);
            prefMgr.setSharedPreferencesMode(MODE_PRIVATE);
            addPreferencesFromResource(R.xml.pref_diary);
            setHasOptionsMenu(true);
